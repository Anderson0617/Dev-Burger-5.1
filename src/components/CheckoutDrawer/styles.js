...
export const OptionButton = styled.button`
  ...
  background-color: ${(props) => (props.$isActive ? "#64b0b3ff" : "#f0f2f5")};
  color: ${(props) => (props.$isActive ? "white" : "#333")};
  border: 2px solid ${(props) => (props.$isActive ? "#c13dc5ff" : "#f0f2f5")};
`;
