...
const DELIVERY_FEE = 7.0;// taxa de entrega
			...
			<Content>
				{paymentStep === "awaiting" ? (
					...
					<ConfirmedContainer>
						...
						<Text>
							Após o envio, Estaremos Verificando o comprovante de
						...
						<ButtonGroup>
							<ActionButton
								...
								style={{ fontWeight: "bold", fontSize: "28px" }} // anderson aqui
							>
								<Send size={40} style={{ marginRight: "8px" }} /> {/* aumentei ícone também */}
								Enviar Pedido
							</ActionButton>
